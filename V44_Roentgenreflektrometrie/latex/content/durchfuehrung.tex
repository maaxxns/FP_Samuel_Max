...
\begin{figure}
    ...
    \begin{minipage}{.5\textwidth}
      ...
      \captionof{figure}{Intensitätsverteilung für den Detektorscan.\cite[6]{anleitung}}
      \label{fig:detektorscan_th}
    \end{minipage}%
    \begin{minipage}{.5\textwidth}
      \centering
      \includegraphics[width=.4\linewidth]{content/data/rockingscan.jpg}
      \captionof{figure}{Intensitätsverteilung für den Rockingscan.\cite[6]{anleitung}}
